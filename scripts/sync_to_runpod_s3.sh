...
#
# Usage:
#   ./scripts/sync_to_runpod_s3.sh                    # sync models only
#   ./scripts/sync_to_runpod_s3.sh --nodes            # also sync custom_nodes
#   ./scripts/sync_to_runpod_s3.sh --dry-run          # preview only
#   ./scripts/sync_to_runpod_s3.sh --ltx23            # sync only LTX 2.3 models
#
