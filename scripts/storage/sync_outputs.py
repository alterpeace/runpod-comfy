...
Usage:
    ...
    uv run python scripts/storage/sync_outputs.py <local_output_dir>
    uv run python scripts/storage/sync_outputs.py <local_output_dir> --watch
    uv run python scripts/storage/sync_outputs.py <local_output_dir> --prefix output/
"""
import argparse
import os
import sys
