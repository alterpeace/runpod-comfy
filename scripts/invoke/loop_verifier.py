...
Usage:
    ...
    uv run python scripts/invoke/loop_verifier.py

    # Verify specific retake against specific source
    uv run python scripts/invoke/loop_verifier.py --retake <output_dir>/al7_velour-01_s42d03l10_20260816_220006_00001.mp4 --source <sample_dir>/clip_26-06-11_17-52-52_00007.mp4

    # Verify all retakes in a directory
    uv run python scripts/invoke/loop_verifier.py --retake-dir <output_dir> --source-dir <sample_dir>
...
Examples:
  ...
  uv run python scripts/invoke/loop_verifier.py --retake output/al7_velour-01_s42d03l10_20260816_220006_00001.mp4

  # Compare retake against original source
  uv run python scripts/invoke/loop_verifier.py --retake output/al7_velour-01_s42d03l10_20260816_220006_00001.mp4 --source <sample_dir>/clip_26-06-11_17-52-52_00007.mp4

  # Verify all retakes in a directory (self-loop check)
  uv run python scripts/invoke/loop_verifier.py --retake-dir <output_dir>
