...
Usage:
    ...
    uv run python scripts/invoke/invoke_v2v_with_upload.py --video rhizome.mp4 --local-file /path/to/rhizome.mp4
    uv run python scripts/invoke/invoke_v2v_with_upload.py --video sample/clip_001.mp4 --prompt "cinematic"
"""
import argparse
import base64
import json
