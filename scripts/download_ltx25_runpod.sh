...
# via the RunPod API. The worker runs scripts/download_ltx25_models.py
# inside the container, downloading models to /runpod-volume/models/ on the
# network volume — no SSH access required.
#
# Usage:
#   ./scripts/download_ltx25_runpod.sh --endpoint-id <id> --profile mid_vram_24gb
#   ./scripts/download_ltx25_runpod.sh --endpoint-id <id> --ids checkpoint_dev_int8 distilled_lora
#   ./scripts/download_ltx25_runpod.sh --endpoint-id <id> --profile low_vram_8gb --dry-run
#   ./scripts/download_ltx25_runpod.sh --endpoint-id <id> --profile full --force
#   ./scripts/download_ltx25_runpod.sh --endpoint-id <id> --list
#
# Prerequisites:
