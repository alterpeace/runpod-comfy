...
Usage:
    uv run python scripts/test_runpod_serverless.py --check-models
    uv run python scripts/test_runpod_serverless.py --run-workflow text_to_video
    uv run python scripts/test_runpod_serverless.py --run-all
"""
