...
Usage:
    python scripts/models/download_ltx25_models.py --profile low_vram_8gb
    python scripts/models/download_ltx25_models.py --ids checkpoint_dev_int8 distilled_lora
    python scripts/models/download_ltx25_models.py --profile full --dry-run
    python scripts/models/download_ltx25_models.py --list
