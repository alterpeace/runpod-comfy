...
#
# Usage:
#   ./scripts/models/install_ltx25.sh                     # profile=mid_vram_24gb (default)
#   ./scripts/models/install_ltx25.sh --profile low_vram_8gb
#   ./scripts/models/install_ltx25.sh --profile full
#   ./scripts/models/install_ltx25.sh --ids checkpoint_dev_int8 distilled_lora
#   ./scripts/models/install_ltx25.sh --dry-run
#   ./scripts/models/install_ltx25.sh --skip-nodes         # models only
