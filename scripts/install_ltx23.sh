...
#
# Usage:
#   ./scripts/install_ltx23.sh                     # profile=mid_vram_12_24gb (default)
#   ./scripts/install_ltx23.sh --profile low_vram_8gb
#   ./scripts/install_ltx23.sh --profile full
#   ./scripts/install_ltx23.sh --ids checkpoint_fp8 distilled_lora iclora_ingredients
#   ./scripts/install_ltx23.sh --dry-run
#   ./scripts/install_ltx23.sh --skip-nodes         # models only
#   ./scripts/install_ltx23.sh --skip-models        # nodes only
#
# Environment:
