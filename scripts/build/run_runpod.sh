...
#   ./scripts/build/run_runpod.sh serverless status          # check endpoint status
#   ./scripts/build/run_runpod.sh serverless logs            # tail handler logs
#   ./scripts/build/run_runpod.sh pods create --gpu "RTX 4090" --name "comfy-prod"
#   ./scripts/build/run_runpod.sh pods list                   # list active pods
#   ./scripts/build/run_runpod.sh pods terminate <pod-id>    # terminate a pod
#
# Prerequisites:
